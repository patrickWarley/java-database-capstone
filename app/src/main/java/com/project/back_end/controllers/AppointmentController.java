...
public class AppointmentController {
  ...
  public ResponseEntity<Map<String, Object>> getAppointments(@PathVariable String patientName, @PathVariable Date date,
    ...
    List<Appointment> appointments = (List<Appointment>) appointmentService
        .getAppointments(patientName, convertedDate, token).get("appointments");
