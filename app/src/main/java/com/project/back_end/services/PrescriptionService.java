...
public class PrescriptionService {
  ...
  public ResponseEntity<Map<String, String>> savePrescription(Prescription aPrescription) {
    try {
      ...
      if (!prescriptions.isEmpty())
        return ResponseEntity.badRequest().body(Map.of("message", "The prescriptions already exists!"));
      ...
      return ResponseEntity.internalServerError()
          .body(Map.of("message", "An error ocurred when trying to save the prescription."));
    }
  }
  ...
  public ResponseEntity<Map<String, Object>> getPrescription(Long appointmentId) {
    try {
      ...
      if (prescriptions.isEmpty())
        return ResponseEntity.badRequest().body(Map.of("message", "No preescriptions found!"));
