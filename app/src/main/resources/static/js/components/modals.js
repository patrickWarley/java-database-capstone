import { patientLoginHandler, doctorLoginHandler, adminLoginHandler, adminAddDoctor } from "../services/index.js";
export function openModal(type) {
  ...
  if (type === 'addDoctor') {
    modalContent = `
         ...
         <input type="text" id="doctorName" placeholder="Doctor Name" class="input-field" required minlength="3" maxlength="100">
        ...
        <input type="password" id="doctorPassword" placeholder="Password" class="input-field" required minlength="6">
        <input type="tel" id="doctorPhone" placeholder="Mobile No." class="input-field" required maxlength="10" minlength="10" pattern="^[0-9]{10}$">
